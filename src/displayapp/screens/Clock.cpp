...
#include "displayapp/screens/WatchFaceSHD.h"
...
std::unique_ptr<Screen> Clock::WatchFaceSHD() {
  return std::make_unique<Screens::WatchFaceSHD>(dateTimeController,
                                                             batteryController,
                                                             bleController,
                                                             notificationManager,
                                                             settingsController,
